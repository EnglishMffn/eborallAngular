  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function MTs(module, __webpack_exports__, __webpack_require__) {
      ...
      PortfolioDetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 23,
        vars: 15,
        consts: [[1, "back-toggle", 3, "routerLink"], ["src", "../../assets/img/arrow-left.svg", "alt", "Back"], [1, "row"], [1, "col-md-12"], [1, "project-head"], [1, "headline"], [1, "summary"], [3, "href", 4, "ngIf"], ["class", "col-12", "style", "padding: 15px;", 4, "ngIf"], [1, "row", "col-12"], [3, "ngClass"], [1, "project-tags"], [4, "ngIf"], ["class", "col-md-6 col-sm-12", 4, "ngIf"], [3, "href"], [1, "img-fluid", 3, "src", "alt"], [1, "col-12", 2, "padding", "15px"], ["target", "_pdf", 1, "button", "full-width", 3, "href"], [1, "col-md-6", "col-sm-12"], [4, "ngFor", "ngForOf"], [1, "img-fluid", 3, "src"]],
    ...
    /***/
    function T5OV(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "YoutubeVideoEmbedComponent", function () {
        return YoutubeVideoEmbedComponent;
      });
      /* harmony import */
      ...
      function YoutubeVideoEmbedComponent_div_0_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var YoutubeVideoEmbedComponent = /*#__PURE__*/function () {
        function YoutubeVideoEmbedComponent() {
          _classCallCheck(this, YoutubeVideoEmbedComponent);
        }

        _createClass(YoutubeVideoEmbedComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }]);
      ...
      YoutubeVideoEmbedComponent.ɵfac = function YoutubeVideoEmbedComponent_Factory(t) {
        return new (t || YoutubeVideoEmbedComponent)();
      };

      YoutubeVideoEmbedComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: YoutubeVideoEmbedComponent,
        selectors: [["app-youtube-video-embed"]],
        inputs: {
          videoId: "videoId"
        },
        decls: 1,
        vars: 1,
        consts: [["class", "embedtool", 4, "ngIf"], [1, "embedtool"], ["frameborder", "0", "allowfullscreen", "", 3, "src"]],
        template: function YoutubeVideoEmbedComponent_Template(rf, ctx) {
          if (rf & 1) {
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _youtube_video_embed_youtube_video_embed_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ./youtube-video-embed/youtube-video-embed.component */
      "T5OV"); // ./src/app/app.module.ts
      // Browser Animations
      // ROUTING
      // SERVICES
      // Contentful Import
